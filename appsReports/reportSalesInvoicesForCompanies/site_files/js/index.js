app.controller('reportSalesInvoicesForCompanies', function ($scope, $http, $timeout) {
  $scope.baseURL = '';
  $scope.appName = 'reportSalesInvoicesForCompanies';
  $scope.list = [];
  $scope.item = {};
  $scope._search = {};
  ...
  $scope.searchAll = function () {
    ...
    $scope.search['customer.commercialCustomer'] = true;
