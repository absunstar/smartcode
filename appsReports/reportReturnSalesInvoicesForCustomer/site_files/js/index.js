app.controller('reportReturnSalesInvoicesForCustomer', function ($scope, $http, $timeout) {
  $scope.baseURL = '';
  $scope.appName = 'reportReturnSalesInvoicesForCustomer';
  $scope.list = [];
  $scope.customersList = [];
  $scope.item = {};
  $scope._search = {};
  ...
  $scope.view = function (_item) {
    ...
    $http({
      method: 'POST',
      url: `/api/returnSalesInvoices/view`,
      data: {
        id: _item.id,
      },
    }).then(
