app.controller('reportEmployeesBonuses', function ($scope, $http, $timeout) {
  $scope.baseURL = '';
  $scope.appName = 'reportEmployeesBonuses';
  $scope.list = [];
  $scope.item = {};
  $scope._search = {};
  $scope.showView = function (_item) {
    ...
    $scope.item = {};
    $scope.view(_item);
    site.showModal('#employeesBonusesManageModal');
  };
