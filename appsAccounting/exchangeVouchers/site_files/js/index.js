app.controller('exchangeVouchers', function ($scope, $http, $timeout) {
    $scope.baseURL = '';
    $scope.appName = 'exchangeVouchers';
    $scope.modalID = '#exchangeVouchersManageModal';
    $scope.modalSearchID = '#exchangeVouchersSearchModal';
    $scope.mode = 'add';
    $scope._search = {};
    $scope.structure = {
        ...
        $http({
            ...
            function (response) {
                ...
                if (response.data.done && response.data.list.length > 0) {
                    ...
                    site.showModal('#exchangeVouchersModalDataList');
                }
            },
            function (err) {
                $scope.busy = false;
    ...
    $scope.setTotalValue = function (item) {
        ...
        site.hideModal('#exchangeVouchersModalDataList');
    };

    $scope.getRreturnSales = function () {
        $scope.busy = true;
        $scope.dataList = [];
        $http({
            method: 'POST',
