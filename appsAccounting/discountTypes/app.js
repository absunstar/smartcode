    ...
    if (app.allowRoute) {
        if (app.allowRouteGet) {
            site.get(
                ...
                (req, res) => {
                    res.render(app.name + '/index.html', { title: app.name, appName: req.word("Discount Types"), setting: site.getCompanySetting(req) }, { parser: 'html', compres: true });
                }
            );
        }
        ...
        if (app.allowRouteAll) {
            site.post({ name: `/api/${app.name}/all`, public: true }, (req, res) => {
                ...
                if (search) {
                    ...
                    where.$or.push({
                        discountType: site.get_RegExp(search, 'i'),
                    });
                }
                    ...
                    if (Array.isArray(docs)) {
                        ...
                        docs.forEach((doc) => {
                            ...
                            let newDoc = {
                                ...
                                image: { url: '/images/discountTypes.png' },
                                active: true,
                            };
