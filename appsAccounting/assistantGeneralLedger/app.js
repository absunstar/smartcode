  ...
  if (app.allowRoute) {
    if (app.allowRouteGet) {
      site.get(
        ...
        (req, res) => {
          res.render(app.name + '/index.html', { title: app.name, appName: req.word("Assistant General Ledger"), setting: site.getCompanySetting(req) }, { parser: 'html', compres: true });
        }
      );
    }
