  ...
  if (app.allowRoute) {
    if (app.allowRouteGet) {
      site.get(
        ...
        (req, res) => {
          res.render(app.name + '/index.html', { title: app.name, appName: req.word("Employees Bonus Names"), setting: site.getCompanySetting(req) }, { parser: 'html', compres: true });
        }
      );
    }
              ...
              app.$collection.find({ nameEn }, (err, doc) => {
                if (!doc) {
                  ...
                  let newDoc = {
                    ...
                    nameAr,
                    nameEn,
                    image: { url: '/images/employeesBonusNames.png' },
                    active: true,
                  };
