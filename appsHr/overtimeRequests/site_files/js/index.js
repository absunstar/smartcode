app.controller('overtimeRequests', function ($scope, $http, $timeout) {
    $scope.baseURL = '';
    $scope.appName = 'overtimeRequests';
    $scope.modalID = '#overtimeRequestsManageModal';
    $scope.modalSearchID = '#overtimeRequestsSearchModal';
    $scope.mode = 'add';
    ...
    $scope.showAdd = function (_item) {
        $scope.error = '';
        $scope.mode = 'add';
        $scope.item = { ...$scope.structure, hours: 0, minutes: 0, requestStatus: 'new', approved: false, finalApproval: false, date: new Date() };
