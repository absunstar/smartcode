  ...
  if (app.allowRoute) {
    if (app.allowRouteGet) {
      site.get(
        ...
        (req, res) => {
          res.render(app.name + '/index.html', { title: app.name, appName: req.word("Jobs"), setting: site.getCompanySetting(req) }, { parser: 'html', compres: true });
        }
      );
    }
          ...
          if (Array.isArray(docs)) {
            ...
            docs.forEach((doc) => {
              ...
              if (docDepartment && nameEn) {
                ...
                department ? (selectedDepartment = { _id: department._id, id: department.id, code: department.code, nameAr: department.nameAr, nameEn: department.nameEn }) : selectedDepartment;
              }
              ...
              app.$collection.find({ nameEn }, (err, doc) => {
                if (!doc) {
                  let numObj = {
                    company: site.getCompany(req),
                    screen: app.name,
