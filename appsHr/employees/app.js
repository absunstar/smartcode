        ...
        if (_att.absent && _att.fingetPrintMissing === false && _att.absent != undefined) {
          ...
          if (_att.attendanceDifference < 0) {
            if (delayRequestIndex == -1 && workErrandIndex == -1) {
              ...
              selectdPenality = penaltiesList.findIndex((penality) => penality.active && absentHourObj.calcualtedCount >= penality.fromMinute && absentHourObj.calcualtedCount <= penality.toMinute);
