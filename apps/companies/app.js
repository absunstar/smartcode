...
//     },
//     (req, res) => {
//       res.render('companies' + '/index.html', { title: 'companies', appName: 'Companies', setting: site.getCompanySetting(req) }, { parser: 'html', compres: true });
//     }
//   );
...
//             companiesDoc = { ...companiesDoc, ...site.companySetting };
