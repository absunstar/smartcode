                        ...
                        _sl.monthsList.forEach((_yl) => {
                            if (_yl.year == new Date(obj.date).getFullYear() && _yl.month == new Date(obj.date).getMonth() + 1) {
                                ...
                                if (_yl.lengthLevel) {
                                    obj.code =
                                        (_sl.prefix || '') +
                                        new Date(obj.date).getFullYear().toString() +
                                        (new Date(obj.date).getMonth() + 1) +
                                        (_yl.separatorSymbol || '') +
                                        addZero(_yl.lastValue, _yl.lengthLevel);
                                } else {
                                    obj.code =
                                        (_sl.prefix || '') + new Date(obj.date).getFullYear().toString() + (new Date(obj.date).getMonth() + 1) + (_yl.separatorSymbol || '') + _yl.lastValue.toString();
                                }
                            }
                        });
                    }
