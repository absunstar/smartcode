    ...
    if (app.allowRoute) {
        if (app.allowRouteGet) {
            site.get(
                ...
                (req, res) => {
                    res.render(app.name + '/index.html', { title: app.name, appName: req.word("Insurance Classes"), setting: site.getCompanySetting(req) }, { parser: 'html', compres: true });
                }
            );
        }
                    ...
                    if (Array.isArray(docs)) {
                        ...
                        docs.forEach((doc) => {
                            ...
                            let newDoc = {
                                ...
                                image: { url: '/images/insuranceClasses.png' },
                                active: true,
                            };
