  ...
  if (app.allowRoute) {
    if (app.allowRouteGet) {
      site.get(
        ...
        (req, res) => {
          res.render(app.name + '/index.html', { title: app.name, appName: req.word("Nurses"), setting: site.getCompanySetting(req) }, { parser: 'html', compres: true });
        }
      );
    }
              ...
              specialtyApp.all({}, (err, specialtiesDocs) => {
                ...
                nationalityApp.all({}, (err, nationalitiesDocs) => {
                  ...
                  newDoc = {
                    ...
                    gender: site.genders ? site.genders.find((t) => t.nameEn && t.nameEn.toLowerCase().trim() == doc.gender.toLowerCase().trim()) : site.genders.find((t) => t.id == 1),
                    email: doc.email,
