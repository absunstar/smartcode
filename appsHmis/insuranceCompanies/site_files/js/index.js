app.controller('insuranceCompanies', function ($scope, $http, $timeout) {
    $scope.baseURL = '';
    $scope.appName = 'insuranceCompanies';
    $scope.modalID = '#insuranceCompaniesManageModal';
    $scope.modalSearchID = '#insuranceCompaniesSearchModal';
    $scope.mode = 'add';
    $scope._search = {};
    $scope.structure = {
