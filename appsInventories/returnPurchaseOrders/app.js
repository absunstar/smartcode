  ...
  if (app.allowRoute) {
    ...
    if (app.allowRouteAll) {
      site.post({ name: `/api/${app.name}/all`, public: true }, (req, res) => {
        ...
        let select = req.body.select || { id: 1, code: 1, invoiceCode: 1, invoiceId: 1, date: 1, vendor: 1, itemsList: 1, paymentType: 1, store: 1, active: 1, image: 1, approved: 1, remainPaid: 1 };
